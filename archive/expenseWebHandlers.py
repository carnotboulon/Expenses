...
class Expense(ndb.Model):
	...
	shop = ndb.KeyProperty(kind='Shop', indexed = True, required = True, required = True)
	category = ndb.KeyProperty(kind='ExpenseCategory', indexed = True, repeated = True, required = True)
